...
@testset "forward.jl" begin
    ...
    @test out.SS_vec[findfirst(out.ph .== "bi")].Comp_apfu ≈ constraint.mineral_composition_apfu["bi"] atol=1e-3
    ...
    @test out_w_mod.SS_vec[findfirst(out_w_mod.ph .== "bi")].Comp_apfu ≈ [2.703201966718807, 1.5935960665623852, 0.0, 0.8769929425165847, 1.7275929039130509, 1.0000000000000002, 0.0, 0.08873358434595208, 12.0, 0.00988253594321993, 1.822532831308096] atol=1e-3
    ...
    @test out_g0_mod.SS_vec[findfirst(out_g0_mod.ph .== "bi")].Comp_apfu ≈ [2.711326941147552, 1.5773461177048962, 0.0, 0.8795051695973085, 1.7337723613120772, 1.0, 0.0, 0.08775150164407976, 12.0, 0.010297908594086575, 1.8244969967118405] atol=1e-3
    ...
    @test out_w_g0_mod.SS_vec[findfirst(out_w_g0_mod.ph .== "bi")].Comp_apfu ≈ [2.6981048656876174, 1.6037902686247656, 0.0, 0.8692846574817923, 1.7295717750076536, 1.0, 0.0, 0.0894953787332389, 12.0, 0.00975305446493273, 1.8210092425335223] atol=1e-3
